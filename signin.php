            ...
            <div class="auth-form__container">
                ...
                <div class="auth-form__aside">
                    <div class="auth-form__help">
                        <a href="#" onclick="document.getElementById('modal_signin').style.display = 'none',document.getElementById('modal_forgot').style.display = 'flex'" class="auth-form__help-link auth-form__help-forgot">
                            Quên mật khẩu
                        </a>
