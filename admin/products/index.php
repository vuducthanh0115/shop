                        ...
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                <li class="category-item category-item--active">
                                    <a href="index.php" class="category-item__link">
                                ...
                                <li class="category-item">
                                    <a href="form_insert.php" class="category-item__link category-item__link--tran">
                                        Thêm sản phẩm
                                    </a>
                                </li>
                            </ul>
                                ...
                                <?php foreach ($result as $each) : ?>
                                    <a class="grid__column-2-5" href="view_details.php?id=<?php echo $each['id']; ?>" style="text-decoration: none; color: blue;">
                                        <div class="content-produce-item">
                                            <div class="content-produce-item__img" style="background-image: url('./images/<?php echo $each['image']; ?>');">
                        ...
                        <div class="pagination">
                            ...
                            <?php $page = 1;
                                ...
                                <li class="pagination-item"><a href="index.php?page=<?php $page == $sum_page ?: $page++;
                                                                                    echo $page; ?>" class="pagination-item__link"><i class="fas fa-chevron-right"></i></a></li>
